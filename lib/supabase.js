...
// Custom storage adapter: uses localStorage when "Kom ihag mig" is checked,
// sessionStorage (cleared on browser close) when unchecked.
const rememberMeStorage = {
  getItem: (key) => {
    if (typeof window === "undefined") return null;
    const remember = localStorage.getItem("bg_remember_me") !== "false";
